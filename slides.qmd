...
scatterplot(outbreak_data, x = class, y = temperature, fill_col = "violet", title = "My scatterplot")
```
...
boxplot(outbreak_data, x = class, y = temperature, fill_col = "gold", title = "My boxplot")
```
